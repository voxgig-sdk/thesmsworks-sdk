// Batch entity client (generated). Shared entity runtime (data/match
...
class BatchEntity : public EntityBase {
public:
  BatchEntity(SdkClient* client, Value entopts = Value::undef())
      : EntityBase("batch", client, entopts) {}
  ...
  EntityPtr make() override {
    ...
    return std::make_shared<BatchEntity>(this->client, opts);
  }

// OneTimePassword entity client (generated). Shared entity runtime (data/match
...
class OneTimePasswordEntity : public EntityBase {
public:
  OneTimePasswordEntity(SdkClient* client, Value entopts = Value::undef())
      : EntityBase("one_time_password", client, entopts) {}
  ...
  EntityPtr make() override {
    ...
    return std::make_shared<OneTimePasswordEntity>(this->client, opts);
  }

// BatchMessage entity client (generated). Shared entity runtime (data/match
...
class BatchMessageEntity : public EntityBase {
public:
  BatchMessageEntity(SdkClient* client, Value entopts = Value::undef())
      : EntityBase("batch_message", client, entopts) {}
  ...
  EntityPtr make() override {
    ...
    return std::make_shared<BatchMessageEntity>(this->client, opts);
  }

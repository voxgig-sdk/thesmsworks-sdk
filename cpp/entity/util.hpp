// Util entity client (generated). Shared entity runtime (data/match
...
class UtilEntity : public EntityBase {
public:
  UtilEntity(SdkClient* client, Value entopts = Value::undef())
      : EntityBase("util", client, entopts) {}
  ...
  EntityPtr make() override {
    ...
    return std::make_shared<UtilEntity>(this->client, opts);
  }

// Schedule entity client (generated). Shared entity runtime (data/match
...
class ScheduleEntity : public EntityBase {
public:
  ScheduleEntity(SdkClient* client, Value entopts = Value::undef())
      : EntityBase("schedule", client, entopts) {}
  ...
  EntityPtr make() override {
    ...
    return std::make_shared<ScheduleEntity>(this->client, opts);
  }

// Flash entity client (generated). Shared entity runtime (data/match
...
class FlashEntity : public EntityBase {
public:
  FlashEntity(SdkClient* client, Value entopts = Value::undef())
      : EntityBase("flash", client, entopts) {}
  ...
  EntityPtr make() override {
    ...
    return std::make_shared<FlashEntity>(this->client, opts);
  }

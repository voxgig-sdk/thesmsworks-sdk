// Message entity client (generated). Shared entity runtime (data/match
...
class MessageEntity : public EntityBase {
public:
  MessageEntity(SdkClient* client, Value entopts = Value::undef())
      : EntityBase("message", client, entopts) {}

// Thesmsworks SDK test-runner SUPPORT (vendor-tag rollout): env overrides,
...
public static class TestRunner
{
    ...
    {
        if (Environment.GetEnvironmentVariable("THESMSWORKS_TEST_LIVE") == "TRUE" ||
            Environment.GetEnvironmentVariable("THESMSWORKS_TEST_OVERRIDE") == "TRUE")
        {
        ...
        var explain = Environment.GetEnvironmentVariable("THESMSWORKS_TEST_EXPLAIN");
    ...
    public static int LiveDelayMs()
    {
        ...
        {
            var n = ThesmsworksSdk.Helpers.ToInt(v);
            if (n >= 0)
            {
                return n;
            }
    ...
    public static Context MakeCtxFromMap(Dictionary<string, object?>? ctxmap,
        ThesmsworksSDK? client, Utility? utility)
    {
            ...
            resRaw is Dictionary<string, object?> resMap)
        {
            ...
            {
                ctx.Result.Err = new ThesmsworksError("", msg, null);
            }
        }
    ...
    public static void FixCtx(Context ctx, ThesmsworksSDK client)
    {
    ...
    public static Exception? ErrFromMap(Dictionary<string, object?>? m)
    {
        ...
        return new ThesmsworksError(code, msg, null);
    }

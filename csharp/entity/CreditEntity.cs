...
public class CreditEntity : ThesmsworksEntityBase
{
    public CreditEntity(ThesmsworksSDK client, Dictionary<string, object?>? entopts = null)
        : base(client, entopts, "credit")
    {
    }

    public override IEntity Make()
    {
        return new CreditEntity(client, CloneOpts());
    }

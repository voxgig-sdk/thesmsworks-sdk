...
public class MessageEntity : ThesmsworksEntityBase
{
    public MessageEntity(ThesmsworksSDK client, Dictionary<string, object?>? entopts = null)
        : base(client, entopts, "message")
    {
    }

    public override IEntity Make()
    {
        return new MessageEntity(client, CloneOpts());
    }

...
public class OneTimePasswordEntity : ThesmsworksEntityBase
{
    public OneTimePasswordEntity(ThesmsworksSDK client, Dictionary<string, object?>? entopts = null)
        : base(client, entopts, "one_time_password")
    {
    }

    public override IEntity Make()
    {
        return new OneTimePasswordEntity(client, CloneOpts());
    }

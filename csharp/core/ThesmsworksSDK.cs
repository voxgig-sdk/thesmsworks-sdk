...
using ThesmsworksSdk.Feature;

namespace ThesmsworksSdk;

public class ThesmsworksSDK
{
    ...
    public ThesmsworksSDK(Dictionary<string, object?>? options = null)
    {
        ...
        var config = global::ThesmsworksSdk.SdkConfig.SharedConfig();
        ...
        // the chain.
        var featureOpts = global::ThesmsworksSdk.Helpers.ToMapAny(global::Voxgig.Struct.StructUtils.GetProp(_options, "feature"))
        ...
        foreach (var fnameObj in featureOrder)
        {
            ...
            var fopts = global::ThesmsworksSdk.Helpers.ToMapAny(global::Voxgig.Struct.StructUtils.GetProp(featureOpts, fname));
            if (fopts != null &&
                fopts.TryGetValue("active", out var active) &&
                active is bool ab && ab)
            {
                _utility.FeatureAdd(_rootctx, global::ThesmsworksSdk.SdkConfig.MakeFeature(fname));
            }
        }
    ...
    {
        return global::ThesmsworksSdk.Utility.Copy(_utility);
    }
    ...
    public Dictionary<string, object?> Prepare(Dictionary<string, object?>? fetchargs)
    {
        ...
        var ctrl = global::ThesmsworksSdk.Helpers.ToMapAny(global::Voxgig.Struct.StructUtils.GetProp(fetchargs, "ctrl"))
            ?? new Dictionary<string, object?>();
        ...
        var pathParams = global::ThesmsworksSdk.Helpers.ToMapAny(global::Voxgig.Struct.StructUtils.GetProp(fetchargs, "params"))
            ?? new Dictionary<string, object?>();
        var query = global::ThesmsworksSdk.Helpers.ToMapAny(global::Voxgig.Struct.StructUtils.GetProp(fetchargs, "query"))
            ?? new Dictionary<string, object?>();
    ...
    private Dictionary<string, object?> OpDenied(string op)
    {
        ...
        {
            ["ok"] = false,
            ["err"] = new Exception("ThesmsworksSDK: " + op +
    ...
    private Dictionary<string, object?> RawRequest(Dictionary<string, object?>? fetchargs)
    {
        ...
        {
            var status = global::ThesmsworksSdk.Helpers.ToInt(global::Voxgig.Struct.StructUtils.GetProp(fm, "status"));
        ...
        Dictionary<string, object?>? ctrl = null)
    {
        ...
        if (null != errors && 0 < errors.Count)
        {
            ...
            res["ok"] = false;
            res["err"] = new Exception("ThesmsworksSDK: graphql: " + msg);
            res["graphql"] = errors;
        }
    ...
    // Idiomatic usage: client.Batch().List(null) or
    // client.Batch().Load(new() { ["id"] = ... }).
    public ThesmsworksEntityBase Batch(Dictionary<string, object?>? entopts = null)
    {
        return new global::ThesmsworksSdk.Entity.BatchEntity(this, entopts);
    }

    // BatchMessage returns a BatchMessage entity bound to this client.
    // Idiomatic usage: client.BatchMessage().List(null) or
    // client.BatchMessage().Load(new() { ["id"] = ... }).
    public ThesmsworksEntityBase BatchMessage(Dictionary<string, object?>? entopts = null)
    {
        return new global::ThesmsworksSdk.Entity.BatchMessageEntity(this, entopts);
    }

    // Credit returns a Credit entity bound to this client.
    // Idiomatic usage: client.Credit().List(null) or
    // client.Credit().Load(new() { ["id"] = ... }).
    public ThesmsworksEntityBase Credit(Dictionary<string, object?>? entopts = null)
    {
    ...
    public ThesmsworksEntityBase Message(Dictionary<string, object?>? entopts = null)
    {
        return new global::ThesmsworksSdk.Entity.MessageEntity(this, entopts);
    }

    // OneTimePassword returns a OneTimePassword entity bound to this client.
    // Idiomatic usage: client.OneTimePassword().List(null) or
    // client.OneTimePassword().Load(new() { ["id"] = ... }).
    ...
    // Idiomatic usage: client.Util().List(null) or
    // client.Util().Load(new() { ["id"] = ... }).
    public ThesmsworksEntityBase Util(Dictionary<string, object?>? entopts = null)
    {
        return new global::ThesmsworksSdk.Entity.UtilEntity(this, entopts);
    }


    public static ThesmsworksSDK TestSDK(Dictionary<string, object?>? testopts,
        Dictionary<string, object?>? sdkopts)
    {
        ...
        var sdk = new ThesmsworksSDK(sdkopts)
        {
            Mode = "test",
        };

...
function envOverride(m) {
    if ('TRUE' === process.env.THESMSWORKS_TEST_LIVE ||
        'TRUE' === process.env.THESMSWORKS_TEST_OVERRIDE) {
    ...
    m.THESMSWORKS_TEST_EXPLAIN = process.env.THESMSWORKS_TEST_EXPLAIN || m.THESMSWORKS_TEST_EXPLAIN;
    return m;
}

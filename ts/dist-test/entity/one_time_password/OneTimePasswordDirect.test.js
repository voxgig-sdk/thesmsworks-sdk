...
(0, node_test_1.describe)('OneTimePasswordDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.ThesmsworksSDK({
    ...
    (0, node_test_1.test)('direct-load-one_time_password', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-one_time_password', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["messageid01"]))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.ThesmsworksSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), {
            apikey: env.THESMSWORKS_APIKEY,
        }));
        let idmap = env['THESMSWORKS_TEST_ONE_TIME_PASSWORD_ENTID'];
    ...
    const client = new __1.ThesmsworksSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=OneTimePasswordDirect.test.js.map
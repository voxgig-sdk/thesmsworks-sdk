...
function basicSetup(extra) {
    ...
    let idmap = transform(['one_time_password01', 'one_time_password02', 'one_time_password03', 'otp01', 'otp02', 'otp03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',

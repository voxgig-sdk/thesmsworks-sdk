...
(0, node_test_1.describe)('BatchDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-batch', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-batch', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['THESMSWORKS_TEST_BATCH_ENTID'];
...
//# sourceMappingURL=BatchDirect.test.js.map
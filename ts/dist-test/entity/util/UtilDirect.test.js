...
(0, node_test_1.describe)('UtilDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-util', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-util', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["errorcode01"]))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['THESMSWORKS_TEST_UTIL_ENTID'];
...
//# sourceMappingURL=UtilDirect.test.js.map
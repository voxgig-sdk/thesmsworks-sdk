...
(0, node_test_1.describe)('CreditEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'credit.' + op, live))
                return;
        }
        ...
        (0, node_assert_1.default)(null != credit_ref01_data_dt0);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/credit/CreditTestData.json');
    ...
    let idmap = transform(['credit01', 'credit02', 'credit03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['THESMSWORKS_TEST_CREDIT_ENTID'];
...
//# sourceMappingURL=CreditEntity.test.js.map
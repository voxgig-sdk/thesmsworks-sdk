...
describe('CreditDirect', async () => {
  ...
  test('direct-load-credit', async (t: any) => {
    const setup = directSetup({ id: 'direct01' })
    if (maybeSkipControl(t, 'direct', 'direct-load-credit', setup.live)) return
...
function directSetup(mockres?: any) {
  ...
  if (live) {
    ...
    let idmap: any = env['THESMSWORKS_TEST_CREDIT_ENTID']

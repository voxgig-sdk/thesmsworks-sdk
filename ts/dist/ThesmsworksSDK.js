...
class ThesmsworksSDK {
    ...
    async graphql(query, variables, ctrl) {
        ...
        if (null != errors && Array.isArray(errors) && 0 < errors.length) {
            ...
            const err = new Error('ThesmsworksSDK: graphql: ' +
    ...
    BatchMessage(entopts) {
        const self = this;
        return new BatchMessageEntity_1.BatchMessageEntity(self, entopts);
    }
    ...
    Util(entopts) {
        const self = this;
        return new UtilEntity_1.UtilEntity(self, entopts);
    }
    static test(testoptsarg, sdkoptsarg) {
        ...
        const testsdk = new ThesmsworksSDK(sdkopts);
        testsdk._mode = 'test';
        return testsdk;
    }
    ...
    toString() {
        return 'Thesmsworks ' + this._utility.struct.jsonify(this.toJSON());
    }
    [node_util_1.inspect.custom]() {
        return this.toString();
    }
}
exports.ThesmsworksSDK = ThesmsworksSDK;
const SDK = ThesmsworksSDK;
exports.SDK = SDK;
//# sourceMappingURL=ThesmsworksSDK.js.map
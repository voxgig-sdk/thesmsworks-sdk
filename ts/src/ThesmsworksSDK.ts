...
class ThesmsworksSDK {
  ...
  async graphql(query: string, variables?: any, ctrl?: any) {
    ...
    if (null != errors && Array.isArray(errors) && 0 < errors.length) {
      ...
      const err: any = new Error('ThesmsworksSDK: graphql: ' +
  ...
  // The argument is the entity OPTIONS object (passed to the entity
  // constructor as entopts), not initial entity data.
  BatchMessage(entopts?: Record<string, any>) {
    const self = this
    return new BatchMessageEntity(self, entopts)
  }
  ...
  // The argument is the entity OPTIONS object (passed to the entity
  // constructor as entopts), not initial entity data.
  Util(entopts?: Record<string, any>) {
    const self = this
    return new UtilEntity(self, entopts)
  }

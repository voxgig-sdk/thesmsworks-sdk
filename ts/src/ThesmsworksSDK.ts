...
class ThesmsworksSDK {
  ...
  BatchMessage(data?: any) {
    const self = this
    return new BatchMessageEntity(self,data)
  }
  ...
  Flash(data?: any) {
    const self = this
    return new FlashEntity(self,data)
  }
  ...
  OneTimePassword(data?: any) {
    const self = this
    return new OneTimePasswordEntity(self,data)
  }
  ...
  Swagger(data?: any) {
    const self = this
    return new SwaggerEntity(self,data)
  }
  ...
  Util(data?: any) {
    const self = this
    return new UtilEntity(self,data)
  }

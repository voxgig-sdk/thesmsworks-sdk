...
class BatchMessageEntity extends ThesmsworksEntityBase<BatchMessage> {

  constructor(client: ThesmsworksSDK, entopts: any) {
    super(client, entopts)
    this.name = 'batch_message'
    this.name_ = 'batch_message'
    this.Name = 'BatchMessage'
  }


  make(this: BatchMessageEntity) {
    return new BatchMessageEntity(this._client, this.entopts())
  }
  ...
  async create(this: any, reqdata?: BatchMessageCreateData, ctrl?: Control): Promise<BatchMessageEntity> {
    ...
    try {
      ...
      if (err) {
        ...
        // Promise<BatchMessage> return stays clean under strict null checks.
  ...
  async remove(
    this: any, reqmatch?: BatchMessageRemoveMatch, ctrl?: Control,
  ): Promise<BatchMessageEntity> {
    ...
    try {
      ...
      if (err) {
        ...
        // Off-happy-path (throw disabled): typed as any so the method's
        // Promise<BatchMessageEntity> return stays clean under strict null checks.
        return undefined as any
      }
    }
  }

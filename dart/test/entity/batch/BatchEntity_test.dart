  ...
  describe('BatchEntity', () {
    ...
    test('basic', (t) async {
      ...
      for (final op in ['load']) {
        if (maybeSkipControl(t, 'entityOp', 'batch.' + op, live)) {
          return;
        }
      }
...
Map<String, dynamic> basicSetup([dynamic extra]) {
  ...
  dynamic idmap = transform(
      <dynamic>['batch01', 'batch02', 'batch03'],
      <String, dynamic>{
        '`\$PACK`': <dynamic>[
          '',
          <String, dynamic>{
  ...
  final idmapEnvVal =
      Platform.environment['THESMSWORKS_TEST_BATCH_ENTID'];

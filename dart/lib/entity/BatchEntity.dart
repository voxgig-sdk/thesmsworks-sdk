...
// Typed models: see ../ThesmsworksTypes.dart (Batch and the per-op request/match types).
class BatchEntity extends ThesmsworksEntityBase {
  BatchEntity(dynamic client, dynamic entopts) : super(client, entopts) {
    name = 'batch';
    name_ = 'batch';
    Name = 'Batch';
  }
  ...
  BatchEntity make() {
    return BatchEntity(client, entopts());
  }


  /// Load a Batch by match (see BatchLoadMatch in
  /// ThesmsworksTypes.dart). Returns the entity data map (Batch).

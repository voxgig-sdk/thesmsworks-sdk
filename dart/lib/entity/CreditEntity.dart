...
// Typed models: see ../ThesmsworksTypes.dart (Credit and the per-op request/match types).
class CreditEntity extends ThesmsworksEntityBase {
  CreditEntity(dynamic client, dynamic entopts) : super(client, entopts) {
    name = 'credit';
    name_ = 'credit';
    Name = 'Credit';
  }
  ...
  CreditEntity make() {
    return CreditEntity(client, entopts());
  }


  /// Load a Credit by match (see CreditLoadMatch in
  /// ThesmsworksTypes.dart). Returns the entity data map (Credit).

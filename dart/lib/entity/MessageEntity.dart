...
class MessageEntity extends ThesmsworksEntityBase {
  MessageEntity(dynamic client, dynamic entopts) : super(client, entopts) {
    name = 'message';
    name_ = 'message';
    Name = 'Message';
  }
  ...
  MessageEntity make() {
    return MessageEntity(client, entopts());
  }


  /// Load a Message by match (see MessageLoadMatch in
  /// ThesmsworksTypes.dart). Returns the entity data map (Message).
  ...
  /// Create a Message (see MessageCreateData in
  /// ThesmsworksTypes.dart). Returns the entity data map (Message).
  ...
  /// Remove a Message by match (see MessageRemoveMatch in
  /// ThesmsworksTypes.dart). Returns the entity data map (Message).

...
// Typed models: see ../ThesmsworksTypes.dart (OneTimePassword and the per-op request/match types).
class OneTimePasswordEntity extends ThesmsworksEntityBase {
  OneTimePasswordEntity(dynamic client, dynamic entopts) : super(client, entopts) {
    name = 'one_time_password';
    name_ = 'one_time_password';
    Name = 'OneTimePassword';
  }

  OneTimePasswordEntity make() {
    return OneTimePasswordEntity(client, entopts());
  }


  /// Load a OneTimePassword by match (see OneTimePasswordLoadMatch in
  /// ThesmsworksTypes.dart). Returns the entity data map (OneTimePassword).
  ...
  /// Create a OneTimePassword (see OneTimePasswordCreateData in
  /// ThesmsworksTypes.dart). Returns the entity data map (OneTimePassword).

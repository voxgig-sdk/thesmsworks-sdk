...
// Typed models: see ../ThesmsworksTypes.dart (BatchMessage and the per-op request/match types).
class BatchMessageEntity extends ThesmsworksEntityBase {
  BatchMessageEntity(dynamic client, dynamic entopts) : super(client, entopts) {
    name = 'batch_message';
    name_ = 'batch_message';
    Name = 'BatchMessage';
  }

  BatchMessageEntity make() {
    return BatchMessageEntity(client, entopts());
  }




  /// Create a BatchMessage (see BatchMessageCreateData in
  /// ThesmsworksTypes.dart). Returns the entity data map (BatchMessage).
  ...
  /// Remove a BatchMessage by match (see BatchMessageRemoveMatch in
  /// ThesmsworksTypes.dart). Returns the entity data map (BatchMessage).

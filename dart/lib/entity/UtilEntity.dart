...
// Typed models: see ../ThesmsworksTypes.dart (Util and the per-op request/match types).
class UtilEntity extends ThesmsworksEntityBase {
  UtilEntity(dynamic client, dynamic entopts) : super(client, entopts) {
    name = 'util';
    name_ = 'util';
    Name = 'Util';
  }
  ...
  UtilEntity make() {
    return UtilEntity(client, entopts());
  }


  /// Load a Util by match (see UtilLoadMatch in
  /// ThesmsworksTypes.dart). Returns the entity data map (Util).

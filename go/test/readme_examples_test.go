...
const testSeed = `map[string]any{"entity": map[string]any{"batch": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "batch_message": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "credit": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "flash": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "message": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "one_time_password": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "schedule": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "swagger": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "util": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`

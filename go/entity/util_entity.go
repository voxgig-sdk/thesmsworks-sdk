...
func NewUtilEntity(client *core.ThesmsworksSDK, entopts map[string]any) *UtilEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *UtilEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *UtilEntity) Deleted() bool {
	return e.deleted
}


func (e *UtilEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewUtilEntity(e.client, opts)
}

func (e *UtilEntity) Data(args ...any) any {
...
func (e *UtilEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Util; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *UtilEntity) DataTyped(data ...Util) Util {
	if len(data) > 0 {
		return typedFrom[Util](e.Data(asMap(data[0])))
	}
	return typedFrom[Util](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Util (all fields
// optional at the wire level).
func (e *UtilEntity) MatchTyped(match ...Util) Util {
	if len(match) > 0 {
		return typedFrom[Util](e.Match(asMap(match[0])))
	}
...
func (e *UtilEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// UtilLoadMatch and returns an Util. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *UtilEntity) LoadTyped(reqmatch UtilLoadMatch, ctrl map[string]any) (Util, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Util{}, err
	}
	return typedFrom[Util](res), nil
}



func (e *UtilEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *UtilEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
...
func (e *UtilEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *UtilEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility

...
func NewBatchMessageEntity(client *core.ThesmsworksSDK, entopts map[string]any) *BatchMessageEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *BatchMessageEntity) GetName() string { return e.name }
...
func (e *BatchMessageEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *BatchMessageEntity) Deleted() bool {
	return e.deleted
}


func (e *BatchMessageEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewBatchMessageEntity(e.client, opts)
}

func (e *BatchMessageEntity) Data(args ...any) any {
...
func (e *BatchMessageEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an BatchMessage; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *BatchMessageEntity) DataTyped(data ...BatchMessage) BatchMessage {
	if len(data) > 0 {
		return typedFrom[BatchMessage](e.Data(asMap(data[0])))
	}
	return typedFrom[BatchMessage](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through BatchMessage (all fields
// optional at the wire level).
func (e *BatchMessageEntity) MatchTyped(match ...BatchMessage) BatchMessage {
	if len(match) > 0 {
		return typedFrom[BatchMessage](e.Match(asMap(match[0])))
	}
	return typedFrom[BatchMessage](e.Match())
}
...
func (e *BatchMessageEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *BatchMessageEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *BatchMessageEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *BatchMessageEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// BatchMessageCreateData and returns an BatchMessage. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *BatchMessageEntity) CreateTyped(reqdata BatchMessageCreateData, ctrl map[string]any) (BatchMessage, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return BatchMessage{}, err
	}
	return typedFrom[BatchMessage](res), nil
}



func (e *BatchMessageEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}



func (e *BatchMessageEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "remove",
		"ctrl":     ctrl,
...
// BatchMessageRemoveMatch and returns an BatchMessage. It delegates to the untyped
// Remove (identical runtime) and converts at the typed boundary.
func (e *BatchMessageEntity) RemoveTyped(reqmatch BatchMessageRemoveMatch, ctrl map[string]any) (BatchMessage, error) {
...
func (e *BatchMessageEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility

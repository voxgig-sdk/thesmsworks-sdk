...
func NewOneTimePasswordEntity(client *core.ThesmsworksSDK, entopts map[string]any) *OneTimePasswordEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *OneTimePasswordEntity) GetName() string { return e.name }
...
func (e *OneTimePasswordEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *OneTimePasswordEntity) Deleted() bool {
	return e.deleted
}


func (e *OneTimePasswordEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewOneTimePasswordEntity(e.client, opts)
}

func (e *OneTimePasswordEntity) Data(args ...any) any {
...
func (e *OneTimePasswordEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an OneTimePassword; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *OneTimePasswordEntity) DataTyped(data ...OneTimePassword) OneTimePassword {
	if len(data) > 0 {
		return typedFrom[OneTimePassword](e.Data(asMap(data[0])))
	}
	return typedFrom[OneTimePassword](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through OneTimePassword (all fields
// optional at the wire level).
func (e *OneTimePasswordEntity) MatchTyped(match ...OneTimePassword) OneTimePassword {
	if len(match) > 0 {
		return typedFrom[OneTimePassword](e.Match(asMap(match[0])))
	}
	return typedFrom[OneTimePassword](e.Match())
}
...
func (e *OneTimePasswordEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *OneTimePasswordEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// OneTimePasswordLoadMatch and returns an OneTimePassword. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *OneTimePasswordEntity) LoadTyped(reqmatch OneTimePasswordLoadMatch, ctrl map[string]any) (OneTimePassword, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return OneTimePassword{}, err
	}
	return typedFrom[OneTimePassword](res), nil
}



func (e *OneTimePasswordEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *OneTimePasswordEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// OneTimePasswordCreateData and returns an OneTimePassword. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *OneTimePasswordEntity) CreateTyped(reqdata OneTimePasswordCreateData, ctrl map[string]any) (OneTimePassword, error) {
...
func (e *OneTimePasswordEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *OneTimePasswordEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *OneTimePasswordEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility

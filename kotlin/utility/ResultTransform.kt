...
fun resultBasic(ctx: Context): voxgig.thesmsworkssdk.core.Result {
...
fun resultBody(ctx: Context): voxgig.thesmsworkssdk.core.Result {
  val response = ctx.response
  val result = ctx.result
...
fun resultHeaders(ctx: Context): voxgig.thesmsworkssdk.core.Result {
  val response = ctx.response
  val result = ctx.result

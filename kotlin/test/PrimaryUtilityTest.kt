...
import voxgig.thesmsworkssdk.sdktest.RunnerSupport.getSpec
import voxgig.thesmsworkssdk.sdktest.RunnerSupport.loadTestSpec
import voxgig.thesmsworkssdk.sdktest.RunnerSupport.makeCtxFromMap
import voxgig.thesmsworkssdk.sdktest.RunnerSupport.runset
...
class PrimaryUtilityTest {
  ...
  private fun client(): ThesmsworksSDK = ThesmsworksSDK.testSDK()

  private fun makeTestCtx(client: ThesmsworksSDK, utility: Utility, overrides: MutableMap<String, Any?>?): Context {
  ...
  private fun makeTestFullCtx(client: ThesmsworksSDK, utility: Utility): Context {
  ...
  fun fetcherBlockedTestMode() {
    val blockedClient = ThesmsworksSDK(
      fhMap(
        "system",
  ...
  fun makeSpecBasic() {
    ...
    val specClient = ThesmsworksSDK.testSDK(null, setupOpts)
  ...
  fun prepareAuthBasic() {
    ...
    val authClient = ThesmsworksSDK.testSDK(null, setupOpts)

...
class UtilDirectTest {
  ...
  fun directLoadUtil() {
    ...
    val reason = RunnerSupport.skipReason("direct", "direct-load-util", mode)
  ...
  companion object {
    ...
    fun directSetup(mockres: Any?): DirectSetup {
      ...
      envm["THESMSWORKS_TEST_UTIL_ENTID"] = linkedMapOf<String, Any?>()
      ...
      if (live) {
        ...
        var idmap: MutableMap<String, Any?> = linkedMapOf()
        val entidRaw = env["THESMSWORKS_TEST_UTIL_ENTID"]

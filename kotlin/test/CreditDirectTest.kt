...
class CreditDirectTest {
  ...
  fun directLoadCredit() {
    ...
    val reason = RunnerSupport.skipReason("direct", "direct-load-credit", mode)
  ...
  companion object {
    ...
    fun directSetup(mockres: Any?): DirectSetup {
      ...
      envm["THESMSWORKS_TEST_CREDIT_ENTID"] = linkedMapOf<String, Any?>()
      ...
      if (live) {
        ...
        var idmap: MutableMap<String, Any?> = linkedMapOf()
        val entidRaw = env["THESMSWORKS_TEST_CREDIT_ENTID"]

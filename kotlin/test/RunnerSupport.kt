...
object RunnerSupport {
  ...
  fun envOverride(m: MutableMap<String, Any?>): MutableMap<String, Any?> {
    if ("TRUE" == getenv("THESMSWORKS_TEST_LIVE") || "TRUE" == getenv("THESMSWORKS_TEST_OVERRIDE")) {
    ...
    val explain = getenv("THESMSWORKS_TEST_EXPLAIN")
  ...
  fun makeCtxFromMap(ctxmapIn: MutableMap<String, Any?>?, client: ThesmsworksSDK?, utility: Utility?): Context {
  ...
  fun fixctx(ctx: Context?, client: ThesmsworksSDK?) {

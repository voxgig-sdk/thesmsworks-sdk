...
class PipelineTest {
  ...
  private fun plClient(sdkopts: MutableMap<String, Any?>?): ThesmsworksSDK {
    return ThesmsworksSDK.testSDK(null, sdkopts)
  }

  private fun plCtx(client: ThesmsworksSDK, utility: Utility, ctrl: MutableMap<String, Any?>?): Context {
  ...
  private fun names(client: ThesmsworksSDK): String {

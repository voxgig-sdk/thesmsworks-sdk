...
object OmniResolver {
   ...
   */
  fun makeRunner(testfile: Any?, client: ThesmsworksSDK?): NamedRunner {
  ...
  private fun sdkProvider(client: ThesmsworksSDK?): Provider = Provider(
    ...
    client = { options ->
      ...
      sdkProvider(ThesmsworksSDK.testSDK(null, opts ?: linkedMapOf()))
    },
   ...
   * per section, by hand.)
   */
  fun omniCtx(arg: Any?, client: ThesmsworksSDK?, utility: Utility?): Context {

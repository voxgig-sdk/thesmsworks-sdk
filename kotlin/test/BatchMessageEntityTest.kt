...
class BatchMessageEntityTest {
  ...
  fun basic() {
    ...
    var batchMessageRef01Data: MutableMap<String, Any?> = (Helpers.toMapAny(Struct.getprop(
  ...
  companion object {
    fun batchMessageBasicSetup(extra: MutableMap<String, Any?>?): RunnerSupport.EntityTestSetup {
      ...
      try {
        ...
        throw AssertionError("failed to read batch_message test data: " + e.message, e)
      }
      ...
      envm["THESMSWORKS_TEST_BATCH_MESSAGE_ENTID"] = idmap

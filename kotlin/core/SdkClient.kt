...
/**
 * Shared client runtime for the Thesmsworks SDK. The generated
 * ThesmsworksSDK class extends this with the API-specific entity accessors;
  ...
  fun graphql(
    ...
    if (null != errors && errors.isNotEmpty()) {
      ...
      res["err"] = SdkError("graphql_error",
        "ThesmsworksSDK: graphql: " + msg, null)
      res["graphql"] = errors
    }

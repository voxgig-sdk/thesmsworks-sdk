...
object Config {
  ...
  fun makeFeature(name: String): Feature {
    return when (name) {
      "debug" -> voxgig.thesmsworkssdk.feature.DebugFeature()
      "idempotency" -> voxgig.thesmsworkssdk.feature.IdempotencyFeature()
      "metrics" -> voxgig.thesmsworkssdk.feature.MetricsFeature()
      "paging" -> voxgig.thesmsworkssdk.feature.PagingFeature()
      "ratelimit" -> voxgig.thesmsworkssdk.feature.RatelimitFeature()
      "retry" -> voxgig.thesmsworkssdk.feature.RetryFeature()
      "test" -> voxgig.thesmsworkssdk.feature.TestFeature()
      "timeout" -> voxgig.thesmsworkssdk.feature.TimeoutFeature()

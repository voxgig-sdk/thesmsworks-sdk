...
|---|---|---|
| `js/` | @voxgig-sdk/thesmsworks-js | `.github/workflows/publish-js.yml` |
| `ts/` | @voxgig-sdk/thesmsworks | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/thesmsworks-js \
      --repository voxgig-sdk/thesmsworks-sdk \
      --file publish-js.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/thesmsworks-js` shows it, and
`npm trust revoke @voxgig-sdk/thesmsworks-js --id=<id>` removes it.

...
public class PipelineTest
{
    ...
    private static (ThesmsworksSDK, Utility) PlClient(Dictionary<string, object?>? sdkopts)
    {
        var client = ThesmsworksSDK.TestSDK(null, sdkopts);
        return (client, client.GetUtility());
    }

    private static Context PlCtx(ThesmsworksSDK client, Utility utility,
    ...
    private class PlEntity : IEntity
    {
        ...
        // ThesmsworksEntityBase: `remove` marks the instance, which keeps the
    ...
    private static Utility UtilWith(ThesmsworksSDK client, FetcherFunc fetcher)
    {
    ...
    public void MakeRequestTransportErrorCarriedOnResponse()
    {
        ...
        Assert.True(resp.Err is ThesmsworksError pe && pe.Code == "boom",

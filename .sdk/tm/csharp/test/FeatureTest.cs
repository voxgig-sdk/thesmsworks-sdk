...
internal static class Fh
{
    ...
    {
        return err is ThesmsworksError se ? se.Code : "";
    }
}
...
public class FeaturePagingTest
{
    ...
    public void StampsPageLimitAndReadsHeaders()
    {
        ...
        Assert.Equal(2, ThesmsworksSdk.Helpers.ToInt(paging["nextPage"]));
        Assert.Equal(5, ThesmsworksSdk.Helpers.ToInt(paging["totalCount"]));

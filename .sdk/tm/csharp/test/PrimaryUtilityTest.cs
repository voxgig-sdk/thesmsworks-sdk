...
public class PrimaryUtilityTest
{
    ...
    private static OmniResolver.Run Run()
    {
        lock (RunLock)
        {
            if (RUN == null)
            {
                CLIENT = ThesmsworksSDK.TestSDK(null, null);
    ...
    private static ThesmsworksSDK GetClient()
    {
        Run();
        return CLIENT!;
    }
    ...
    private static Context MakeTestCtx(ThesmsworksSDK client, Utility utility,
    ...
    private static Context MakeTestFullCtx(ThesmsworksSDK client, Utility utility)
    {
    ...
    {
        var hookClient = ThesmsworksSDK.TestSDK(null, null);
    ...
    {
        var initClient = ThesmsworksSDK.TestSDK(null, null);
    ...
    public void FetcherBlockedTestMode()
    {
        ...
        var blockedClient = new ThesmsworksSDK(new Dictionary<string, object?>
        {
            ["base"] = "http://localhost:8080",
            ["system"] = new Dictionary<string, object?>
            {
    ...
    public void MakeSpecBasic()
    {
        ...
        var specClient = ThesmsworksSDK.TestSDK(null, setupOpts);
    ...
    // ThesmsworksError. The corpus says `match: out: code` for both, so
    ...
    public void PrepareAuthBasic()
    {
        ...
        var authClient = ThesmsworksSDK.TestSDK(null, setupOpts);

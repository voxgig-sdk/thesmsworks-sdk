...
public class PrimaryUtilityTest
{
    ...
    private readonly ThesmsworksSDK _client;
    ...
    public PrimaryUtilityTest()
    {
        ...
        _client = ThesmsworksSDK.TestSDK(null, null);
        _utility = _client.GetUtility();
    }

    // Helper: create basic test context.
    private Context MakeTestCtx(ThesmsworksSDK client, Utility utility,
    ...
    private Context MakeTestFullCtx(ThesmsworksSDK client, Utility utility)
    {

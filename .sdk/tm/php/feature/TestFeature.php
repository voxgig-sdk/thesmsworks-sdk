...
class ThesmsworksTestFeature extends ThesmsworksBaseFeature
{
    ...
    public function init(ThesmsworksContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (ThesmsworksContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = ThesmsworksParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (ThesmsworksContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(ThesmsworksContext $ctx, $op, $args): array
    {

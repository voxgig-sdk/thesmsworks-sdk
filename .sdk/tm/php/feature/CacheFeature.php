...
class ThesmsworksCacheFeature extends ThesmsworksBaseFeature
{
    ...
    private function _through(ThesmsworksContext $ctx, string $url, array $fetchdef, callable $inner): array
    {

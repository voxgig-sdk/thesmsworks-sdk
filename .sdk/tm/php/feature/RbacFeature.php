...
class ThesmsworksRbacFeature extends ThesmsworksBaseFeature
{
    ...
    private function _required(ThesmsworksContext $ctx): ?string
    {
    ...
    private function _reject(ThesmsworksContext $ctx, string $required): void
    {
    ...
    private function _track(ThesmsworksContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;

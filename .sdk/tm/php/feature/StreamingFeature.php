...
class ThesmsworksStreamingFeature extends ThesmsworksBaseFeature
{
    ...
    private function _iterate(ThesmsworksResult $result): \Generator
    {
    ...
    private function _streamable(ThesmsworksContext $ctx): bool
    {

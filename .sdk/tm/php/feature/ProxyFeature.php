...
class ThesmsworksProxyFeature extends ThesmsworksBaseFeature
{
    ...
    public function init(ThesmsworksContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (ThesmsworksContext $ctx2, string $url2, array $fetchdef) use ($inner): array {

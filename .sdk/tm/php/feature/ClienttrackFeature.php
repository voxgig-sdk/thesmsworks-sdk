...
class ThesmsworksClienttrackFeature extends ThesmsworksBaseFeature
{
    ...
    public function PostConstruct(ThesmsworksContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Thesmsworks-SDK';

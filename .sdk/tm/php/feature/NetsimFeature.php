...
// Thesmsworks SDK netsim feature
...
class ThesmsworksNetsimFeature extends ThesmsworksBaseFeature
{
    ...
    private function _simulate(ThesmsworksContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(ThesmsworksContext $ctx, array $applied): void
    {
        $client = $this->client;

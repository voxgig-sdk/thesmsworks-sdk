...
// Thesmsworks SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class ThesmsworksTransformResponse
{
    public static function call(ThesmsworksContext $ctx): mixed
    {
        ...
        $transform = ThesmsworksHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }

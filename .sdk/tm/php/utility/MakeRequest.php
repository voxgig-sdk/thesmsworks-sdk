...
// Thesmsworks SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class ThesmsworksMakeRequest
{
    public static function call(ThesmsworksContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new ThesmsworksResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new ThesmsworksResponse($fetched);
        } else {

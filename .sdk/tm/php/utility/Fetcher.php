...
class ThesmsworksFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; ThesmsworksSDK/1.0)';
    ...
    public static function call(ThesmsworksContext $ctx, string $fullurl, array $fetchdef): array
    {

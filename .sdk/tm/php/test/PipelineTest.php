...
{
    private static function utility(): ThesmsworksUtility
    {
        return new ThesmsworksUtility();
    }
    ...
    private static function ctx(array $over = []): ThesmsworksContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new ThesmsworksContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new ThesmsworksOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof ThesmsworksError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new ThesmsworksOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = ThesmsworksMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new ThesmsworksOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = ThesmsworksMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new ThesmsworksOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = ThesmsworksMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new ThesmsworksSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = ThesmsworksMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new ThesmsworksResponse([]),
            'result' => new ThesmsworksResult([]),
        ]);
        [, $err] = ThesmsworksMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new ThesmsworksSpec([]),
            'response' => null,
            'result' => new ThesmsworksResult([]),
        ]);
        [, $err] = ThesmsworksMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new ThesmsworksSpec(['step' => 's']),
            'response' => new ThesmsworksResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new ThesmsworksResult([]),
        ]);
        [, $err] = ThesmsworksMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new ThesmsworksSpec(['step' => 's']),
            'response' => new ThesmsworksResponse(self::resp(200, ['v' => 1])),
            'result' => new ThesmsworksResult([]),
        ]);
        [, $err] = ThesmsworksMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new ThesmsworksSpec(['step' => 's']),
            'response' => new ThesmsworksResponse(self::resp(200, ['v' => 2])),
            'result' => new ThesmsworksResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        ThesmsworksMakeResponse::call($ctx);
    ...
    {
        $preset = new ThesmsworksResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new ThesmsworksSpec([]),
            'response' => new ThesmsworksResponse([]),
            'result' => new ThesmsworksResult([]),
        ...
        [$got, $err] = ThesmsworksMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new ThesmsworksResult([])]);
        [, $err] = ThesmsworksMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new ThesmsworksSpec([]), 'result' => null]);
        [, $err] = ThesmsworksMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new ThesmsworksSpec(['step' => 's']),
            'result' => new ThesmsworksResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new ThesmsworksOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = ThesmsworksMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new ThesmsworksSpec(['step' => 's']),
            'result' => new ThesmsworksResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new ThesmsworksOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = ThesmsworksMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new ThesmsworksResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new ThesmsworksSpec([]),
            'result' => new ThesmsworksResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = ThesmsworksMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = ThesmsworksMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new ThesmsworksError('boom', 'boom');
        $utility->fetcher = function (ThesmsworksContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new ThesmsworksSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = ThesmsworksMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (ThesmsworksContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = ThesmsworksMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(ThesmsworksResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        ThesmsworksMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (ThesmsworksContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new ThesmsworksSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = ThesmsworksMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new ThesmsworksResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new ThesmsworksSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = ThesmsworksMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = ThesmsworksMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = ThesmsworksMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new ThesmsworksResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, ThesmsworksDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new ThesmsworksResult(['ok' => false])]);
        $this->expectException(ThesmsworksError::class);
        ThesmsworksDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new ThesmsworksResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', ThesmsworksMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        ThesmsworksMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new ThesmsworksBaseFeature();
        $b = new ThesmsworksBaseFeature();
        ThesmsworksFeatureAdd::call($ctx, $a);
        ThesmsworksFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): ThesmsworksBaseFeature
    {
        $f = new ThesmsworksBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        ThesmsworksFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): ThesmsworksContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new ThesmsworksSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = ThesmsworksPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        ThesmsworksPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new ThesmsworksResponse(['headers' => null]),
            'result' => new ThesmsworksResult([]),
        ]);
        ThesmsworksResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        ThesmsworksResultBody::call($ctx);

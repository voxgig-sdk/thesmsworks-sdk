...
// ---- SDK client-base generic helpers (Main.fragment ThesmsworksSDK) -------
...
voxgig_value* sdk_options_map(ThesmsworksSDK* sdk) { return voxgig_clone(sdk->options); }

Utility* sdk_get_utility(ThesmsworksSDK* sdk) { return utility_copy(sdk->utility); }

Context* sdk_get_root_ctx(ThesmsworksSDK* sdk) { return sdk->rootctx; }

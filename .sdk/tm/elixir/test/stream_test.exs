# Thesmsworks SDK entity stream() test
#
...
defmodule Thesmsworks.StreamTest do
  use ExUnit.Case
  ...
  defp has_feature?(name) do
    f = S.getprop(Thesmsworks.Config.make_config(), "feature")
  ...
  defp entity(sdk, name), do: apply(Thesmsworks, String.to_atom(name), [sdk, nil])
  defp entmod(name), do: Module.concat([Thesmsworks.Entity, Macro.camelize(name)])

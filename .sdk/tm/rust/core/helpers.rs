// Shared Value helpers for the Thesmsworks SDK pipeline. The SDK data model
...
// underlying API spec doesn't define. The static ThesmsworksEntity trait
...
pub fn unsupported_op(opname: &str, entityname: &str) -> ThesmsworksError {
    ThesmsworksError::new(
        "unsupported_op",
        &format!(

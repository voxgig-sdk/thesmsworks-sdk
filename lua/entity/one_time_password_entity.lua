...
local OneTimePasswordEntity = {}
OneTimePasswordEntity.__index = OneTimePasswordEntity


function OneTimePasswordEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, OneTimePasswordEntity)
  self._name = "one_time_password"
  self._client = client
...
function OneTimePasswordEntity:get_name()
  return self._name
end


function OneTimePasswordEntity:make()
  local opts = {}
...
function OneTimePasswordEntity:mark_deleted()
  self._deleted = true
end


function OneTimePasswordEntity:deleted()
  return true == self._deleted
end


function OneTimePasswordEntity:data_set(args)
  if args ~= nil then
...
function OneTimePasswordEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function OneTimePasswordEntity:match_set(args)
  if args ~= nil then
...
function OneTimePasswordEntity:match_get()
...
function OneTimePasswordEntity:stream(action, args, callopts)
...
---@param reqmatch OneTimePasswordLoadMatch
---@param ctrl? table
---@return OneTimePassword
---@return string? err
function OneTimePasswordEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqdata OneTimePasswordCreateData
---@param ctrl? table
---@return OneTimePassword
---@return string? err
function OneTimePasswordEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
function OneTimePasswordEntity:_run_op(ctx, post_done)
  local utility = self._utility

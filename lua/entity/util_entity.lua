...
local UtilEntity = {}
UtilEntity.__index = UtilEntity


function UtilEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, UtilEntity)
  self._name = "util"
  self._client = client
...
function UtilEntity:get_name()
  return self._name
end


function UtilEntity:make()
  local opts = {}
...
function UtilEntity:mark_deleted()
  self._deleted = true
end


function UtilEntity:deleted()
  return true == self._deleted
end


function UtilEntity:data_set(args)
  if args ~= nil then
...
function UtilEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function UtilEntity:match_set(args)
  if args ~= nil then
...
function UtilEntity:stream(action, args, callopts)
...
---@param reqmatch UtilLoadMatch
---@param ctrl? table
---@return Util
---@return string? err
function UtilEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function UtilEntity:_run_op(ctx, post_done)
  local utility = self._utility

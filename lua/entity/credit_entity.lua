...
local CreditEntity = {}
CreditEntity.__index = CreditEntity


function CreditEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, CreditEntity)
  self._name = "credit"
  self._client = client
...
function CreditEntity:get_name()
  return self._name
end


function CreditEntity:make()
  local opts = {}
...
function CreditEntity:mark_deleted()
  self._deleted = true
end


function CreditEntity:deleted()
  return true == self._deleted
end


function CreditEntity:data_set(args)
  if args ~= nil then
...
function CreditEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function CreditEntity:match_set(args)
  if args ~= nil then
...
function CreditEntity:match_get()
...
function CreditEntity:stream(action, args, callopts)
...
---@param reqmatch CreditLoadMatch
---@param ctrl? table
---@return Credit
---@return string? err
function CreditEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function CreditEntity:_run_op(ctx, post_done)
  local utility = self._utility

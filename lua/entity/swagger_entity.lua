...
local SwaggerEntity = {}
SwaggerEntity.__index = SwaggerEntity


function SwaggerEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, SwaggerEntity)
  self._name = "swagger"
  self._client = client
...
function SwaggerEntity:get_name()
  return self._name
end


function SwaggerEntity:make()
  local opts = {}
...
function SwaggerEntity:mark_deleted()
  self._deleted = true
end


function SwaggerEntity:deleted()
  return true == self._deleted
end


function SwaggerEntity:data_set(args)
  if args ~= nil then
...
function SwaggerEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function SwaggerEntity:match_set(args)
  if args ~= nil then
...
function SwaggerEntity:match_get()
...
function SwaggerEntity:stream(action, args, callopts)
...
function SwaggerEntity:_run_op(ctx, post_done)
  local utility = self._utility

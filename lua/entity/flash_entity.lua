...
local FlashEntity = {}
FlashEntity.__index = FlashEntity


function FlashEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, FlashEntity)
  self._name = "flash"
  self._client = client
...
function FlashEntity:get_name()
  return self._name
end


function FlashEntity:make()
  local opts = {}
...
function FlashEntity:mark_deleted()
  self._deleted = true
end


function FlashEntity:deleted()
  return true == self._deleted
end


function FlashEntity:data_set(args)
  if args ~= nil then
...
function FlashEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function FlashEntity:match_set(args)
  if args ~= nil then
...
function FlashEntity:match_get()
...
function FlashEntity:stream(action, args, callopts)
...
function FlashEntity:_run_op(ctx, post_done)
  local utility = self._utility

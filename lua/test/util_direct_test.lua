...
describe("UtilDirect", function()
  it("should direct-load-util", function()
    local setup = util_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-util", setup.live and "live" or "unit")
...
function util_direct_setup(mockres)

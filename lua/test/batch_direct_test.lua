...
describe("BatchDirect", function()
  it("should direct-load-batch", function()
    local setup = batch_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-batch", setup.live and "live" or "unit")

...
describe("CreditDirect", function()
  it("should direct-load-credit", function()
    local setup = credit_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-credit", setup.live and "live" or "unit")

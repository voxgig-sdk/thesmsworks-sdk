...
function runner.env_override(m)
  local live = runner.getenv("THESMSWORKS_TEST_LIVE")
  local override = runner.getenv("THESMSWORKS_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("THESMSWORKS_TEST_EXPLAIN")

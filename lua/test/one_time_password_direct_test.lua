...
describe("OneTimePasswordDirect", function()
  it("should direct-load-one_time_password", function()
    local setup = one_time_password_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-one_time_password", setup.live and "live" or "unit")

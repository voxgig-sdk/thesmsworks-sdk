...
// tm/swift/Tests/ThesmsworksSDKTests/OmniResolver.swift, and it follows the
...
use thesmsworks_sdk::utility::voxgigstruct::ordered_map::OrderedMap;
use thesmsworks_sdk::utility::voxgigstruct::value::Value;
use thesmsworks_sdk::utility::voxgigstruct::InjectDef;
use thesmsworks_sdk::ThesmsworksError;
...
pub fn vget(val: &Value, key: &str) -> Value {
    thesmsworks_sdk::utility::voxgigstruct::lookup(val, &Value::str(key))
}

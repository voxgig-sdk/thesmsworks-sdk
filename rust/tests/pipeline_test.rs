...
fn util_with(client: &Rc<ThesmsworksSDK>, fetcher: FetcherFn) -> Rc<Utility> {
...
fn pipeline_feature_add_ordering_before_after_replace() {
    ...
    let names = |client: &Rc<ThesmsworksSDK>| -> String {
        client
            .features
            .borrow()
            .iter()
...
use thesmsworks_sdk::core::helpers::get_str;

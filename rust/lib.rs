// Thesmsworks SDK for Rust (generated by @voxgig/sdkgen).
//
...
pub use crate::core::error::ThesmsworksError;
...
pub use crate::core::sdk::{test_sdk, ThesmsworksSDK};
pub use crate::core::spec::Spec;
pub use crate::core::types::{
    Entity, Feature, FeatureRef, FetcherFn, OutVal, ThesmsworksEntity,
};
...
// No-argument convenience constructors: `thesmsworks_sdk::new()` /
// `thesmsworks_sdk::test()` for the common no-options case.
use std::rc::Rc;

pub fn new() -> Rc<ThesmsworksSDK> {
    ThesmsworksSDK::new(Value::Noval)
}

pub fn test() -> Rc<ThesmsworksSDK> {

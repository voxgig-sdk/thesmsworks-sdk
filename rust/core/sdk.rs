// ThesmsworksSDK client (generated — mirrors the go Main fragment).
...
impl ThesmsworksSDK {
    pub fn new(options: Value) -> Rc<ThesmsworksSDK> {
        let sdk = Rc::new(ThesmsworksSDK {
    ...
    pub fn prepare(&self, fetchargs: Value) -> Result<Value, ThesmsworksError> {
    ...
    pub fn direct(&self, fetchargs: Value) -> Result<Value, ThesmsworksError> {
    ...
    fn op_denied(&self, op: &str) -> Value {
        ...
        jo(vec![
            ...
            ("err", Value::str(format!(
                "ThesmsworksSDK: {}: operation not allowed by SDK option \
    ...
    // gate by passing it.
    fn raw_request(&self, fetchargs: Value) -> Result<Value, ThesmsworksError> {
        let utility = &self.utility;
    ...
    pub fn graphql(
        ...
        if let Value::List(items) = &errors {
            ...
            if let Some(first) = first {
                ...
                setp(&res, "err",
                     Value::str(format!("ThesmsworksSDK: graphql: {}", msg)));
    ...
    pub fn batch(self: &Rc<Self>, entopts: Value) -> Rc<crate::entity::batch::BatchEntity> {
        crate::entity::batch::BatchEntity::new(self, entopts)
    }

    /// BatchMessage entity bound to this client.
    pub fn batch_message(self: &Rc<Self>, entopts: Value) -> Rc<crate::entity::batch_message::BatchMessageEntity> {
        crate::entity::batch_message::BatchMessageEntity::new(self, entopts)
    }

    /// Credit entity bound to this client.
    pub fn credit(self: &Rc<Self>, entopts: Value) -> Rc<crate::entity::credit::CreditEntity> {
    ...
    pub fn util(self: &Rc<Self>, entopts: Value) -> Rc<crate::entity::util::UtilEntity> {
...
pub fn test_sdk(testopts: Value, sdkopts: Value) -> Rc<ThesmsworksSDK> {
    ...
    let sdk = ThesmsworksSDK::new(sdkopts);
    *sdk.mode.borrow_mut() = "test".to_string();

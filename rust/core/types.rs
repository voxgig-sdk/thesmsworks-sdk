...
pub trait ThesmsworksEntity: Entity {
    fn load(&self, reqmatch: Value, ctrl: Value) -> Result<Value, ThesmsworksError>;
    fn list(&self, reqmatch: Value, ctrl: Value) -> Result<Value, ThesmsworksError>;
    fn create(&self, reqdata: Value, ctrl: Value) -> Result<Value, ThesmsworksError>;
    fn update(&self, reqdata: Value, ctrl: Value) -> Result<Value, ThesmsworksError>;

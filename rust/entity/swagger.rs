// Swagger entity client (generated — mirrors the go Entity fragment).
...
impl SwaggerEntity {
    pub fn new(client: &Rc<ThesmsworksSDK>, entopts: Value) -> Rc<SwaggerEntity> {
...
impl Entity for SwaggerEntity {
    ...
    fn make(&self) -> Rc<dyn Entity> {
        ...
        SwaggerEntity::new(&self.client, opts) as Rc<dyn Entity>
    }

// OneTimePassword entity client (generated — mirrors the go Entity fragment).
...
pub struct OneTimePasswordEntity {
    name: String,
    #[allow(dead_code)]
...
impl OneTimePasswordEntity {
    pub fn new(client: &Rc<ThesmsworksSDK>, entopts: Value) -> Rc<OneTimePasswordEntity> {
        ...
        let e = Rc::new(OneTimePasswordEntity {
            name: "one_time_password".to_string(),
            client: client.clone(),
...
impl Entity for OneTimePasswordEntity {
    ...
    fn make(&self) -> Rc<dyn Entity> {
        ...
        OneTimePasswordEntity::new(&self.client, opts) as Rc<dyn Entity>
    }

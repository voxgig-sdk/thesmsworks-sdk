// Message entity client (generated — mirrors the go Entity fragment).
...
impl MessageEntity {
    pub fn new(client: &Rc<ThesmsworksSDK>, entopts: Value) -> Rc<MessageEntity> {
...
impl Entity for MessageEntity {
    ...
    fn make(&self) -> Rc<dyn Entity> {
        ...
        MessageEntity::new(&self.client, opts) as Rc<dyn Entity>
    }
...
impl ThesmsworksEntity for MessageEntity {

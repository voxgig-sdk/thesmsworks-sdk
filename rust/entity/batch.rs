// Batch entity client (generated — mirrors the go Entity fragment).
...
impl BatchEntity {
    pub fn new(client: &Rc<ThesmsworksSDK>, entopts: Value) -> Rc<BatchEntity> {
...
impl Entity for BatchEntity {
    ...
    fn make(&self) -> Rc<dyn Entity> {
        ...
        BatchEntity::new(&self.client, opts) as Rc<dyn Entity>
    }
...
impl ThesmsworksEntity for BatchEntity {

// Util entity client (generated — mirrors the go Entity fragment).
...
impl UtilEntity {
    pub fn new(client: &Rc<ThesmsworksSDK>, entopts: Value) -> Rc<UtilEntity> {
...
impl Entity for UtilEntity {
    ...
    fn make(&self) -> Rc<dyn Entity> {
        ...
        UtilEntity::new(&self.client, opts) as Rc<dyn Entity>
    }
...
impl ThesmsworksEntity for UtilEntity {

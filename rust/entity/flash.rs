// Flash entity client (generated — mirrors the go Entity fragment).
...
impl FlashEntity {
    pub fn new(client: &Rc<ThesmsworksSDK>, entopts: Value) -> Rc<FlashEntity> {
...
impl Entity for FlashEntity {
    ...
    fn make(&self) -> Rc<dyn Entity> {
        ...
        FlashEntity::new(&self.client, opts) as Rc<dyn Entity>
    }
...
impl ThesmsworksEntity for FlashEntity {

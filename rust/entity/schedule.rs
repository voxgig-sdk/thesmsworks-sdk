// Schedule entity client (generated — mirrors the go Entity fragment).
...
impl ScheduleEntity {
    pub fn new(client: &Rc<ThesmsworksSDK>, entopts: Value) -> Rc<ScheduleEntity> {
...
impl Entity for ScheduleEntity {
    ...
    fn make(&self) -> Rc<dyn Entity> {
        ...
        ScheduleEntity::new(&self.client, opts) as Rc<dyn Entity>
    }

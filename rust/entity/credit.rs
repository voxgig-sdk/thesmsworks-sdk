// Credit entity client (generated — mirrors the go Entity fragment).
...
impl CreditEntity {
    pub fn new(client: &Rc<ThesmsworksSDK>, entopts: Value) -> Rc<CreditEntity> {
...
impl Entity for CreditEntity {
    ...
    fn make(&self) -> Rc<dyn Entity> {
        ...
        CreditEntity::new(&self.client, opts) as Rc<dyn Entity>
    }
...
impl ThesmsworksEntity for CreditEntity {

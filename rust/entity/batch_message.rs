// BatchMessage entity client (generated — mirrors the go Entity fragment).
...
use crate::core::sdk::ThesmsworksSDK;
use crate::core::types::{Entity, ThesmsworksEntity};
use crate::core::utility_type::Utility;
use crate::utility::voxgigstruct as vs;
use crate::utility::voxgigstruct::Value;

pub struct BatchMessageEntity {
    name: String,
    #[allow(dead_code)]
...
impl BatchMessageEntity {
    pub fn new(client: &Rc<ThesmsworksSDK>, entopts: Value) -> Rc<BatchMessageEntity> {
        ...
        let e = Rc::new(BatchMessageEntity {
            name: "batch_message".to_string(),
            client: client.clone(),
    ...
    pub fn stream(
        ...
        args: Value,
        callopts: Value,
    ) -> Result<std::vec::IntoIter<Value>, ThesmsworksError> {
...
impl Entity for BatchMessageEntity {
    ...
    fn make(&self) -> Rc<dyn Entity> {
        ...
        BatchMessageEntity::new(&self.client, opts) as Rc<dyn Entity>
    }
...
impl ThesmsworksEntity for BatchMessageEntity {
    ...
    fn remove(self: &Rc<Self>, reqmatch: Value, ctrl: Value) -> Result<Rc<Self>, ThesmsworksError> {
        let ctx = self.utility.make_context(
            CtxSpec {

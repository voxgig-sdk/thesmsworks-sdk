...
public final class Context {
  ...
  public var client: ThesmsworksSDK?
  ...
  public init(_ ctxmap: [String: Any?]?, _ basectx: Context?) {
    ...
    // Client
    if let sdk = ctxProp(ctxmap, "client") as? ThesmsworksSDK { client = sdk }
  ...
  public func makeError(_ code: String, _ msg: String) -> ThesmsworksError {

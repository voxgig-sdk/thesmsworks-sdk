// ThesmsworksEntityBase - shared entity behaviour: construction, data/match
...
open class ThesmsworksEntityBase: Entity {
  var name: String
  var client: ThesmsworksSDK
  var utility: Utility
  var entopts: VMap
  var data = VMap()
  var match = VMap()
  ...
  public init(_ client: ThesmsworksSDK, _ entoptsIn: VMap?, _ name: String) {
  ...
  open func make() -> Entity {
    return ThesmsworksEntityBase(client, cloneOpts(), name)
  }

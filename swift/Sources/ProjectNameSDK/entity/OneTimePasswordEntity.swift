...
public final class OneTimePasswordEntity: ThesmsworksEntityBase {
  public init(_ client: ThesmsworksSDK, _ entopts: VMap? = nil) {
    super.init(client, entopts, "one_time_password")
  }

  public override func make() -> Entity {
    return OneTimePasswordEntity(client, cloneOpts())
  }

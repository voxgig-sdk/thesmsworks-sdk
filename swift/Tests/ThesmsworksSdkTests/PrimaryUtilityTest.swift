...
final class PrimaryUtilityTest: XCTestCase {
  ...
  private static func primaryRun() throws -> OmniResolver.Run {
    ...
    let run = try OmniResolver.makeRunner(
      SdkRunner.testJsonPath(), ThesmsworksSDK.testSDK(nil, nil))("primary")
    RUN = run
    return run
  }
  ...
  override func setUp() {
    super.setUp()
    client = ThesmsworksSDK.testSDK(nil, nil)
  ...
  private func makeTestCtx(_ client: ThesmsworksSDK, _ utility: Utility,
  ...
  private func makeTestFullCtx(_ client: ThesmsworksSDK, _ utility: Utility) -> Context {
  ...
  func testFeatureHookBasic() {
    let hookClient = ThesmsworksSDK.testSDK(nil, nil)
  ...
  func testFeatureInitBasic() {
    let initClient = ThesmsworksSDK.testSDK(nil, nil)
  ...
  func testExtendOptionInstallsAndInitialisesTheFeature() {
    ...
    let client = ThesmsworksSDK.testSDK(nil, opts)
  ...
  func testFetcherLive() throws {
    ...
    let liveClient = ThesmsworksSDK(opts)
  ...
  func testFetcherBlockedTestMode() {
    ...
    let opts = VMap()
    opts.entries["system"] = .map(vm(("fetch", .nat(fetch))))
    let blockedClient = ThesmsworksSDK(opts)
  ...
  func testMakeSpecBasic() throws {
    ...
    let specClient = ThesmsworksSDK.testSDK(nil, setupOpts)
  ...
  func testPrepareAuthBasic() throws {
    ...
    let authClient = ThesmsworksSDK.testSDK(nil, setupOpts)

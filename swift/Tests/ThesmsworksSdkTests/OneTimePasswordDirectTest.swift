// one_time_password direct API test (generated from the API model).

import XCTest

@testable import ThesmsworksSdk

final class OneTimePasswordDirectTest: XCTestCase {
  func testDirectMock() {
    ...
    let args = VMap()
    args.entries["path"] = .string("/one_time_password")

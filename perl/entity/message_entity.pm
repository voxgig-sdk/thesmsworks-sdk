...
# Returns the current Message data (hashref).
sub data_get {
  my ($self) = @_;
...
# Returns the current match filter (any subset of Message fields).
sub match_get {
  my ($self) = @_;
...
#
# reqmatch: match criteria hashref (id/query fields; MessageLoadMatch
...
# Returns the loaded Message data (hashref); dies with ThesmsworksError
# on failure.
sub load {
...
#
# reqdata: body data hashref (MessageCreateData shape). ctrl: optional
# per-call control. Returns the created Message data (hashref); dies
...
#
# reqmatch: match criteria hashref (id/query fields; MessageRemoveMatch
# shape). ctrl: optional per-call control. Returns the removed Message

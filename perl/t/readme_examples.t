#!perl
# Thesmsworks SDK - documentation example COMPLETENESS gate.
#
...
#      (ThesmsworksSDK->test) against the real SDK. Captured output is scanned for
...
# becomes ThesmsworksSDK->test(<fixtures>); a block that only uses $client gets

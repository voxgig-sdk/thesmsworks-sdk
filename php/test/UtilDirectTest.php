...
class UtilDirectTest extends TestCase
{
    public function test_direct_load_util(): void
    {
        $setup = util_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-util", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {

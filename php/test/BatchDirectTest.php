...
class BatchDirectTest extends TestCase
{
    public function test_direct_load_batch(): void
    {
        $setup = batch_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-batch", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
...
function batch_direct_setup($mockres)
{

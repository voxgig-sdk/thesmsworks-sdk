...
class ScheduleEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set THESMSWORKS_TEST_SCHEDULE_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function schedule_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("THESMSWORKS_TEST_SCHEDULE_ENTID");

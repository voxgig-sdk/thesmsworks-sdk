...
// Thesmsworks SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = ThesmsworksOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(ThesmsworksOmni::structfix($now, Struct::undef()))
                        !== json_encode(ThesmsworksOmni::structfix($val, Struct::undef()))) {

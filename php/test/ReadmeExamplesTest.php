...
//      EXECUTED offline in seeded test mode (ThesmsworksSDK::test)
...
{
    private const SDK_CLASS = 'ThesmsworksSDK';
    ...
    private const SDK_BASE = 'thesmsworks_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../thesmsworks_sdk.php';
        foreach ($this->phpBlocks() as $blk) {

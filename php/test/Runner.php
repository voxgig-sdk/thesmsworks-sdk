...
class ThesmsworksTestRunner
{
    ...
    {
        $live = self::getenv('THESMSWORKS_TEST_LIVE');
        $override = self::getenv('THESMSWORKS_TEST_OVERRIDE');
        ...
        $explain = self::getenv('THESMSWORKS_TEST_EXPLAIN');
...
class_alias('ThesmsworksTestRunner', 'Runner');
class_alias('ThesmsworksHelpers', 'Helpers');

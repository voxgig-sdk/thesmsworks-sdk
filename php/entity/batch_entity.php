...
class BatchEntity
{
     ...
     * Load a single Batch.
     *
     * @param BatchLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed BatchLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Batch|array The loaded Batch as an assoc-array at the

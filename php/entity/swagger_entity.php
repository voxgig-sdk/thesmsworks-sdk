...
class SwaggerEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new SwaggerEntity($this->_client, $opts);
    }

    /**
     * @param Swagger|array $args Swagger data (assoc-array) to store.
     */
    ...
    /**
     * @return Swagger|array The current Swagger data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Swagger fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Swagger fields).
     */

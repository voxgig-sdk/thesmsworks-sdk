...
class UtilEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new UtilEntity($this->_client, $opts);
    }

    /**
     * @param Util|array $args Util data (assoc-array) to store.
     */
    ...
    /**
     * @return Util|array The current Util data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Util fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Util fields).
     */
     ...
     * Load a single Util.
     *
     * @param UtilLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed UtilLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Util|array The loaded Util as an assoc-array at the

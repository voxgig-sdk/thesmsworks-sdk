...
class MessageEntity
{
     ...
     *
     * @param MessageRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; MessageRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Message|array The removed Message as an assoc-array at the
     *   SDK boundary; throws ThesmsworksError on failure (item-5 convention).
     */

...
// Thesmsworks SDK BatchMessage entity
...
class BatchMessageEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new BatchMessageEntity($this->_client, $opts);
    }

    /**
     * @param BatchMessage|array $args BatchMessage data (assoc-array) to store.
     */
    ...
    /**
     * @return BatchMessage|array The current BatchMessage data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of BatchMessage fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of BatchMessage fields).
     */
     ...
     *
     * @param BatchMessageCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed BatchMessageCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return BatchMessage|array The created BatchMessage as an assoc-array at the
    ...
    /**
     * Remove an BatchMessage matching the given criteria.
     *
     * @param BatchMessageRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; BatchMessageRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return BatchMessage|array The removed BatchMessage as an assoc-array at the
     *   SDK boundary; throws ThesmsworksError on failure (item-5 convention).
     */

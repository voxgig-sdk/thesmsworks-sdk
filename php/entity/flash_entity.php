...
class FlashEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new FlashEntity($this->_client, $opts);
    }

    /**
     * @param Flash|array $args Flash data (assoc-array) to store.
     */
    ...
    /**
     * @return Flash|array The current Flash data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Flash fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Flash fields).
     */

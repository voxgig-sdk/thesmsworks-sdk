...
class ThesmsworksPagingFeature extends ThesmsworksBaseFeature
{
    ...
    private function _graphql_pre_request(ThesmsworksContext $ctx, array $paging): void
    {
        $body = $ctx->spec->body;
        if (!is_array($body)) {
            return;
    ...
    private function _is_list(ThesmsworksContext $ctx): bool
    {

...
// Thesmsworks SDK timeout feature
...
class ThesmsworksTimeoutFeature extends ThesmsworksBaseFeature
{
    ...
    private function _with_timeout(ThesmsworksContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(ThesmsworksContext $_ctx, float $ms): void
    {
        $client = $this->client;

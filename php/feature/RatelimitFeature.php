...
// Thesmsworks SDK ratelimit feature
...
class ThesmsworksRatelimitFeature extends ThesmsworksBaseFeature
{
    ...
    private function _acquire(ThesmsworksContext $ctx): void
    {
    ...
    private function _track(ThesmsworksContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;

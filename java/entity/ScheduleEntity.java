...
public class ScheduleEntity extends EntityBase {

  public ScheduleEntity(SdkClient client, Map<String, Object> entopts) {
    super("schedule", client, entopts);
  }

  @Override
  public Entity make() {
    Map<String, Object> opts = new LinkedHashMap<>(this.entopts);
    return new ScheduleEntity(this.client, opts);
  }

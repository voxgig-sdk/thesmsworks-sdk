...
public class CreditEntity extends EntityBase {

  public CreditEntity(SdkClient client, Map<String, Object> entopts) {
    super("credit", client, entopts);
  }

  @Override
  public Entity make() {
    Map<String, Object> opts = new LinkedHashMap<>(this.entopts);
    return new CreditEntity(this.client, opts);
  }

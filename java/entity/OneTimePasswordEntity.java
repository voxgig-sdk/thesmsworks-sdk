...
/** OneTimePassword entity client for the Thesmsworks SDK. */
@SuppressWarnings({"unchecked", "unused"})
public class OneTimePasswordEntity extends EntityBase {

  public OneTimePasswordEntity(SdkClient client, Map<String, Object> entopts) {
    super("one_time_password", client, entopts);
  }

  @Override
  public Entity make() {
    Map<String, Object> opts = new LinkedHashMap<>(this.entopts);
    return new OneTimePasswordEntity(this.client, opts);
  }

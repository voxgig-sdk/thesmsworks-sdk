...
public class BatchEntity extends EntityBase {

  public BatchEntity(SdkClient client, Map<String, Object> entopts) {
    super("batch", client, entopts);
  }

  @Override
  public Entity make() {
    Map<String, Object> opts = new LinkedHashMap<>(this.entopts);
    return new BatchEntity(this.client, opts);
  }

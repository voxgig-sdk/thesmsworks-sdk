...
| `metadata` | `Map<String, Object>` | An array of objects containing metadata key/value pairs that have been saved on messages. |
...
| `length` | `Map<String, Object>` | The length of the generated passcode. |
| `metadata` | `Map<String, Object>` | A JSON object of no longer than 1024 bytes, containing as many parameters as you wish, to store data for use in your application. |

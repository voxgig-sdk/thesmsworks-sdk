...
| `destinations` | `vector` | Telephone numbers of each of the recipients |
...
| `responseemail` | `vector` | An optional list of email addresses to forward responses to this specific message to. |

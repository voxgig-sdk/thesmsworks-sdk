;; Thesmsworks SDK OneTimePassword entity (generated by @voxgig/sdkgen).
(ns sdk.entity.one_time_password
...
(defn- new-entity [client entopts]
  (let [entopts (ensure-entopts entopts)
        ...
        ent {:_name "one_time_password" :_client client :_utility utility :_entopts entopts
             :_data data :_match match :_entctx entctx
             :get-name (fn [] "one_time_password")
...
;; Canonical facade: (OneTimePassword client data) accessor delegates here.
...
;; Load a single OneTimePassword (reqmatch: id/query fields; nil = empty match).
...
;; Create a new OneTimePassword (reqdata: body data).

;; Thesmsworks SDK Util entity (generated by @voxgig/sdkgen).
(ns sdk.entity.util
...
(defn- new-entity [client entopts]
  (let [entopts (ensure-entopts entopts)
        ...
        ent {:_name "util" :_client client :_utility utility :_entopts entopts
...
;; Canonical facade: (Util client data) accessor delegates here.
...
;; Load a single Util (reqmatch: id/query fields; nil = empty match).

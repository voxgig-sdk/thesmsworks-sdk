;; Thesmsworks SDK Credit entity (generated by @voxgig/sdkgen).
(ns sdk.entity.credit
...
(defn- new-entity [client entopts]
  (let [entopts (ensure-entopts entopts)
        ...
        ent {:_name "credit" :_client client :_utility utility :_entopts entopts
...
;; Canonical facade: (Credit client data) accessor delegates here.
...
;; Load a single Credit (reqmatch: id/query fields; nil = empty match).

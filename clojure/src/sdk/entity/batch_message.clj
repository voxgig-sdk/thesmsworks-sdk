;; Thesmsworks SDK BatchMessage entity (generated by @voxgig/sdkgen).
(ns sdk.entity.batch_message
...
;; Canonical facade: (BatchMessage client data) accessor delegates here.
...
;; Create a new BatchMessage (reqdata: body data).

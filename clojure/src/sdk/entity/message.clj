;; Thesmsworks SDK Message entity (generated by @voxgig/sdkgen).
(ns sdk.entity.message
...
(defn- new-entity [client entopts]
  (let [entopts (ensure-entopts entopts)
        ...
        ent {:_name "message" :_client client :_utility utility :_entopts entopts
...
;; Canonical facade: (Message client data) accessor delegates here.
...
;; Create a new Message (reqdata: body data).

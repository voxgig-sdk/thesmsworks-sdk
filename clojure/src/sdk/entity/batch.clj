...
(defn- new-entity [client entopts]
  (let [entopts (ensure-entopts entopts)
        ...
        ent {:_name "batch" :_client client :_utility utility :_entopts entopts
...
;; Canonical facade: (Batch client data) accessor delegates here.
...
;; Load a single Batch (reqmatch: id/query fields; nil = empty match).

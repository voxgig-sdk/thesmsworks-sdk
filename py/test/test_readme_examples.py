# Thesmsworks SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions ThesmsworksSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both ThesmsworksSDK(...) and ThesmsworksSDK.test(...) become
#      ThesmsworksSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "thesmsworks_sdk"
_SDK_CLASS = "ThesmsworksSDK"

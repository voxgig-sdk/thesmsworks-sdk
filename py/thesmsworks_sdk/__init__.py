...
from thesmsworks_sdk.utility import register

# Load features
from thesmsworks_sdk.feature.base_feature import ThesmsworksBaseFeature
from thesmsworks_sdk.features import _has_feature, _make_feature
...
class ThesmsworksSDK:
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("ThesmsworksSDK: graphql: " + str(msg))
            res["graphql"] = errors

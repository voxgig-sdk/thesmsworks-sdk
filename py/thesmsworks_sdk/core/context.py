...
from thesmsworks_sdk.core.helpers import get_ctx_prop, to_map
...
class ThesmsworksContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(sp, ThesmsworksSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, ThesmsworksResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, ThesmsworksResponse):
            self.response = rp
        elif basectx is not None:

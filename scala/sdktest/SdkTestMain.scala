// Runtime test suite for the Thesmsworks SDK — a dependency-free scala-cli
...
object SdkTestMain {
  ...
  final class FhHarness {
    var client: ThesmsworksSDK = null
  ...
  private def testEntityCrud(): Unit = {
    ...
    val sdk = ThesmsworksSDK.testSDK(om("entity" -> fixtures), null)
  ...
  private def testEntityStream(): Unit = {
    ...
    val sdk = ThesmsworksSDK.testSDK(om("entity" -> fixtures),
    ...
    // items.
    val sdk2 = ThesmsworksSDK.testSDK(om("entity" -> fixtures), null)

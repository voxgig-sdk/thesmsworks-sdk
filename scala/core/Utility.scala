...
class Utility private (noregister: Boolean) {
  ...
  val struct: voxgig.thesmsworkssdk.utility.StructUtility.type = voxgig.thesmsworkssdk.utility.StructUtility

  def this() = {
    this(false)
    voxgig.thesmsworkssdk.utility.Register.registerAll(this)
  }

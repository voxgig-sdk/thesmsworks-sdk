...
class OneTimePasswordEntity(client0: SdkClient, entopts0: JMap[String, Object]) extends EntityBase("one_time_password", client0, entopts0) {

  override def make(): Entity = {
    val opts = new LinkedHashMap[String, Object](this.entopts)
    new OneTimePasswordEntity(this.client, opts)
  }

...
// Message entity client for the Thesmsworks SDK.
class MessageEntity(client0: SdkClient, entopts0: JMap[String, Object]) extends EntityBase("message", client0, entopts0) {

  override def make(): Entity = {
    val opts = new LinkedHashMap[String, Object](this.entopts)
    new MessageEntity(this.client, opts)
  }

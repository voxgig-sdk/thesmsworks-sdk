...
| `responseemail` | `java.util.List[Object]` | No | An optional list of email addresses to forward responses to this specific message to. |
...
| `ttl` | `java.lang.Double` | No | The optional number of minutes before the delivery report is deleted. |

...
| Field | Type | Description |
| --- | --- | --- |
| `ai` | `java.lang.Boolean` | Used to determine whether The SMS Works AI Optimiser should be used in the event that the message is just longer than the 1 or 2 credit boundary. |
...
| `destinations` | `java.util.List[Object]` | Telephone numbers of each of the recipients |
...
| `ttl` | `java.lang.Double` | The number of minutes before the delivery report is deleted. |
| `validity` | `java.lang.Double` | The optional number of minutes to attempt delivery before the message is marked as EXPIRED. |
...
| `ai` | `java.lang.Boolean` | Used to determine whether The SMS Works AI Optimiser should be used in the event that the message is just longer than the 1 or 2 credit boundary. |
| `content` | `String` | Message to send to the recipient. |
| `credits` | `java.lang.Double` | The number of credits used on the message. |
| `deliveryreporturl` | `String` | The url to which we should POST delivery reports to for this message. |
...
| `limit` | `java.lang.Double` | The maximum number of messages that you would like returned in this call. |
| `metadata` | `java.util.Map[String, Object]` | An array of objects containing metadata key/value pairs that have been saved on messages. |
| `responseemail` | `java.util.List[Object]` | An optional list of email addresses to forward responses to this specific message to. |
| `schedule` | `String` | Date at which to send the message. |
| `sender` | `String` | The sender of the message. |
| `skip` | `java.lang.Double` | The number of results you would like to ignore before returning messages. |
...
| `ttl` | `java.lang.Double` | The optional number of minutes before the delivery report is deleted. |
| `unread` | `java.lang.Boolean` | In queries for incoming messages ('status' is 'INCOMING'), specify whether you explicitly want unread messages (true) or read messages (false). |
| `validity` | `java.lang.Double` | The optional number of minutes to attempt delivery before the message is marked as EXPIRED. |
...
| `length` | `java.util.Map[String, Object]` | The length of the generated passcode. |
| `metadata` | `java.util.Map[String, Object]` | A JSON object of no longer than 1024 bytes, containing as many parameters as you wish, to store data for use in your application. |
...
| `validity` | `java.lang.Double` | The length of time in seconds for which the generated passcode should be valid. |

...
class OneTimePasswordEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set THESMSWORKS_TEST_ONE_TIME_PASSWORD_ENTID JSON to run live"
      return
    end
    client = setup[:client]
    ...
    one_time_password_ref01_data_dt0_loaded = one_time_password_ref01_ent.load(one_time_password_ref01_match_dt0, nil)
    assert !one_time_password_ref01_data_dt0_loaded.nil?

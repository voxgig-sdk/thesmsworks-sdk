...
module ThesmsworksTestRunner
  ...
  def self.env_override(m)
    live = getenv("THESMSWORKS_TEST_LIVE")
    override = getenv("THESMSWORKS_TEST_OVERRIDE")
    ...
    explain = getenv("THESMSWORKS_TEST_EXPLAIN")
    m["THESMSWORKS_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = ThesmsworksTestRunner
Helpers = ThesmsworksHelpers
Vs = VoxgigStruct

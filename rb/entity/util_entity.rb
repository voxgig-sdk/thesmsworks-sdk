...
class UtilEntity
  ...
  # @return [Util, Hash] the current Util data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Util fields)
  def match_get
  ...
  # Load a single Util.
  #
  # @param reqmatch [UtilLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Util.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Util, Hash] the loaded Util; raises ThesmsworksError on failure

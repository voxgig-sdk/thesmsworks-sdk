...
class CreditEntity
  ...
  # @return [Credit, Hash] the current Credit data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Credit fields)
  def match_get
  ...
  #
  # @param reqmatch [CreditLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Credit.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Credit, Hash] the loaded Credit; raises ThesmsworksError on failure

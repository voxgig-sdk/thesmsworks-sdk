...
class BatchMessageEntity
  ...
  def make
    opts = @_entopts.dup
    BatchMessageEntity.new(@_client, opts)
  end
  ...
  # @return [BatchMessage, Hash] the current BatchMessage data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of BatchMessage fields)
  def match_get
  ...
  #
  # @param reqdata [BatchMessageCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [BatchMessage, Hash] the created BatchMessage; raises ThesmsworksError on failure
  ...
  #
  # @param reqmatch [BatchMessageRemoveMatch, Hash, nil] match criteria (id/query fields)
  # @param ctrl [Object, nil] optional per-call control
  # @return [BatchMessage, Hash] the removed BatchMessage; raises ThesmsworksError on failure

...
class OneTimePasswordEntity
  ...
  def make
    opts = @_entopts.dup
    OneTimePasswordEntity.new(@_client, opts)
  end
  ...
  # @return [OneTimePassword, Hash] the current OneTimePassword data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of OneTimePassword fields)
  def match_get
  ...
  #
  # @param reqmatch [OneTimePasswordLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.OneTimePassword.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [OneTimePassword, Hash] the loaded OneTimePassword; raises ThesmsworksError on failure
  ...
  #
  # @param reqdata [OneTimePasswordCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [OneTimePassword, Hash] the created OneTimePassword; raises ThesmsworksError on failure

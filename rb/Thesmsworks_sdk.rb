...
require_relative 'Thesmsworks_types'
...
class ThesmsworksSDK
  ...
  def initialize(options = {})
    ...
    feature_opts = ThesmsworksHelpers.to_map(VoxgigStruct.getprop(@options, "feature"))
    if feature_opts
      featureorder = VoxgigStruct.getpath(@options, "__derived__.featureorder")
      if featureorder.is_a?(Array)
        featureorder.each do |fname|
          fopts = ThesmsworksHelpers.to_map(feature_opts[fname])
          if fopts && fopts["active"] == true
            utility.feature_add.call(@_rootctx, ThesmsworksFeatures.make_feature(fname))
          end
        end
      end
    end
  ...
  def get_utility
    ThesmsworksUtility.copy(@_utility)
  end
  ...
  def prepare(fetchargs = {})
    ...
    ctrl = ThesmsworksHelpers.to_map(VoxgigStruct.getprop(fetchargs, "ctrl")) || {}
    ...
    params = ThesmsworksHelpers.to_map(VoxgigStruct.getprop(fetchargs, "params")) || {}
    query = ThesmsworksHelpers.to_map(VoxgigStruct.getprop(fetchargs, "query")) || {}
  ...
  def raw_request(fetchargs = {})
    ...
    if fetched.is_a?(Hash)
      status = ThesmsworksHelpers.to_int(VoxgigStruct.getprop(fetched, "status"))
  ...
  def graphql(query, variables = nil, ctrl = nil)
    ...
    if errors.is_a?(Array) && !errors.empty?
      ...
      res["ok"] = false
      res["err"] = ThesmsworksError.new(
        "graphql_error", "ThesmsworksSDK: graphql: #{msg}")
      res["graphql"] = errors
    end
  ...
  # Canonical facade: client.BatchMessage.list / client.BatchMessage.load({ "id" => ... })
  def BatchMessage(data = nil)
    require_relative 'entity/batch_message_entity'
    BatchMessageEntity.new(self, data)
  end
  ...
  # Canonical facade: client.OneTimePassword.list / client.OneTimePassword.load({ "id" => ... })
  ...
  # Canonical facade: client.Util.list / client.Util.load({ "id" => ... })
  def Util(data = nil)
    require_relative 'entity/util_entity'
    UtilEntity.new(self, data)
  end
  ...
  def self.test(testopts = nil, sdkopts = nil)
    ...
    sdk = ThesmsworksSDK.new(sdkopts)
    sdk.mode = "test"
    sdk
  end
end

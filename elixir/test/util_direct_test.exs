# Util direct test (offline, mock system.fetch)

defmodule Thesmsworks.UtilDirectTest do
  use ExUnit.Case
  ...
  test "should direct load util" do
    canned = S.jm(["id", "direct01"])
    sdk = mk(canned)
    res = Thesmsworks.direct(sdk, H.deep(%{"path" => "/util/direct01", "method" => "GET", "params" => %{}}))

# Credit entity test (offline, mock transport)

defmodule Thesmsworks.CreditEntityTest do
  use ExUnit.Case
  ...
  defp fixture do
    Json.parse(File.read!("../.sdk/test/entity/credit/CreditTestData.json"))
  end
  ...
  defp first_id do
    existing = H.or_(S.getpath(fixture(), "existing.credit"), S.jm([]))

# Thesmsworks SDK corpus test runner: the vendored @voxgig/omni engine driven
...
# and tm/swift/Tests/ThesmsworksSDKTests/OmniResolver.swift.
#
...
defmodule Thesmsworks.Omni do
  ...
  defp sdkprovider(client) do
    utility = Thesmsworks.get_utility(client)
    ...
    %{
      ...
      client: fn options -> sdkprovider(Thesmsworks.test(nil, tostruct(options))) end,
  ...
  def errify(%Thesmsworks.Error{} = err) do

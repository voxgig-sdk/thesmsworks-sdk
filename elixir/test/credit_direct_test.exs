# Credit direct test (offline, mock system.fetch)

defmodule Thesmsworks.CreditDirectTest do
  use ExUnit.Case
  ...
  test "should direct load credit" do
    canned = S.jm(["id", "direct01"])
    sdk = mk(canned)
    res = Thesmsworks.direct(sdk, H.deep(%{"path" => "/credit/direct01", "method" => "GET", "params" => %{}}))

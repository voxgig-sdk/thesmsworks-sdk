# Message direct test (offline, mock system.fetch)

defmodule Thesmsworks.MessageDirectTest do
  use ExUnit.Case
  ...
  test "should direct load message" do
    canned = S.jm(["id", "direct01"])
    sdk = mk(canned)
    res = Thesmsworks.direct(sdk, H.deep(%{"path" => "/message/direct01", "method" => "GET", "params" => %{}}))

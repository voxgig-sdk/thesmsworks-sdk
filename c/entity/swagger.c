// Swagger entity client (generated — mirrors the rust Entity fragment).
...
static const char* swagger_get_name(Entity* e);
...
Entity* swagger_entity_new(ThesmsworksSDK* client, voxgig_value* entopts) {
  ...
  swagger_entity* self = (swagger_entity*)calloc(1, sizeof(swagger_entity));
  self->base.vt = &swagger_VT;
  self->name = strdup("swagger");
  self->client = client;
...
static voxgig_value* swagger_run_op(swagger_entity* self, Context* ctx,
                                    swagger_postdone_fn post_done, PNError** err) {
...
voxgig_value* swagger_stream(Entity* e, const char* action, voxgig_value* args,
                             voxgig_value* callopts, PNError** err) {
  swagger_entity* self = (swagger_entity*)e;
  *err = NULL;
  ...
  Context* ctx = make_context_util(cs, swagger_ent_ctx(self));
...
static Entity* swagger_make(Entity* e) {
  ...
  return swagger_entity_new(self->client, opts);
}
...
static voxgig_value* swagger_data(Entity* e, voxgig_value* args) {
  ...
  if (args && !v_is_noval(args) && !v_is_null(args)) {
    ...
    feature_hook_util(swagger_ent_ctx(self), "SetData");
  }
  feature_hook_util(swagger_ent_ctx(self), "GetData");
...
static voxgig_value* swagger_matchv(Entity* e, voxgig_value* args) {
  ...
  if (args && !v_is_noval(args) && !v_is_null(args)) {
    ...
    feature_hook_util(swagger_ent_ctx(self), "SetMatch");
  }
  feature_hook_util(swagger_ent_ctx(self), "GetMatch");

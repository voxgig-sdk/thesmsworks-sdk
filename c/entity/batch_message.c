// BatchMessage entity client (generated — mirrors the rust Entity fragment).
...
typedef struct batch_message_entity {
...
static const char* batch_message_get_name(Entity* e);
...
Entity* batch_message_entity_new(ThesmsworksSDK* client, voxgig_value* entopts) {
  ...
  batch_message_entity* self = (batch_message_entity*)calloc(1, sizeof(batch_message_entity));
  self->base.vt = &batch_message_VT;
  self->name = strdup("batch_message");
  self->client = client;
...
static voxgig_value* batch_message_run_op(batch_message_entity* self, Context* ctx,
                                    batch_message_postdone_fn post_done, PNError** err) {
...
voxgig_value* batch_message_stream(Entity* e, const char* action, voxgig_value* args,
...
static const char* batch_message_get_name(Entity* e) {
  return ((batch_message_entity*)e)->name;
}
...
static Entity* batch_message_make(Entity* e) {
  ...
  return batch_message_entity_new(self->client, opts);
}
...
static voxgig_value* batch_message_data(Entity* e, voxgig_value* args) {
  ...
  if (args && !v_is_noval(args) && !v_is_null(args)) {
    ...
    feature_hook_util(batch_message_ent_ctx(self), "SetData");
  }
  feature_hook_util(batch_message_ent_ctx(self), "GetData");
...
static voxgig_value* batch_message_matchv(Entity* e, voxgig_value* args) {
  ...
  if (args && !v_is_noval(args) && !v_is_null(args)) {
    ...
    feature_hook_util(batch_message_ent_ctx(self), "SetMatch");
  }
  feature_hook_util(batch_message_ent_ctx(self), "GetMatch");
...
static void batch_message_create_postdone(batch_message_entity* self, Context* ctx) {
...
static void batch_message_remove_postdone(batch_message_entity* self, Context* ctx) {
  SdkResult* result = ctx->result;
  if (result) {
...
static const EntityVT batch_message_VT = {
  ...
  batch_message_update,
  batch_message_remove,
};

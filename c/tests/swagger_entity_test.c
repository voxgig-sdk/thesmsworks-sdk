...
int main(void) {
  ...
  // the materialised items — either way every item is yielded.
  {
    ...
    Entity* se = thesmsworks_swagger(strsdk, NULL);
    PNError* serr = NULL;
    voxgig_value* items = swagger_stream(se, "list", NULL, NULL, &serr);
    ...
    Entity* pe = thesmsworks_swagger(plainsdk, NULL);
    PNError* perr = NULL;
    voxgig_value* pitems = swagger_stream(pe, "list", NULL, NULL, &perr);

...
int main(void) {
  ...
  // the materialised items — either way every item is yielded.
  {
    ...
    Entity* se = thesmsworks_schedule(strsdk, NULL);
    PNError* serr = NULL;
    voxgig_value* items = schedule_stream(se, "list", NULL, NULL, &serr);
    ...
    Entity* pe = thesmsworks_schedule(plainsdk, NULL);
    PNError* perr = NULL;
    voxgig_value* pitems = schedule_stream(pe, "list", NULL, NULL, &perr);

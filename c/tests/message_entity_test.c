...
int main(void) {
  ...
  // the materialised items — either way every item is yielded.
  {
    ...
    Entity* se = thesmsworks_message(strsdk, NULL);
    PNError* serr = NULL;
    voxgig_value* items = message_stream(se, "list", NULL, NULL, &serr);
    ...
    Entity* pe = thesmsworks_message(plainsdk, NULL);
    PNError* perr = NULL;
    voxgig_value* pitems = message_stream(pe, "list", NULL, NULL, &perr);

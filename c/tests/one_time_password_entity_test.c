...
int main(void) {
  ...
  // the materialised items — either way every item is yielded.
  {
    ...
    Entity* se = thesmsworks_one_time_password(strsdk, NULL);
    PNError* serr = NULL;
    voxgig_value* items = one_time_password_stream(se, "list", NULL, NULL, &serr);
    ...
    Entity* pe = thesmsworks_one_time_password(plainsdk, NULL);
    PNError* perr = NULL;
    voxgig_value* pitems = one_time_password_stream(pe, "list", NULL, NULL, &perr);

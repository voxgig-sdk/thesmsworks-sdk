// Behavioural feature-test harness for the Thesmsworks SDK (C port of the
...
#ifndef THESMSWORKS_FEATURE_HARNESS_H
#define THESMSWORKS_FEATURE_HARNESS_H
...
#endif // THESMSWORKS_FEATURE_HARNESS_H

...
int main(void) {
  ...
  // the materialised items — either way every item is yielded.
  {
    ...
    Entity* se = thesmsworks_credit(strsdk, NULL);
    PNError* serr = NULL;
    voxgig_value* items = credit_stream(se, "list", NULL, NULL, &serr);
    ...
    Entity* pe = thesmsworks_credit(plainsdk, NULL);
    PNError* perr = NULL;
    voxgig_value* pitems = credit_stream(pe, "list", NULL, NULL, &perr);

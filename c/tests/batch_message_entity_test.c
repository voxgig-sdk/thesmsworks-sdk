...
int main(void) {
  ...
  // the materialised items — either way every item is yielded.
  {
    ...
    Entity* se = thesmsworks_batch_message(strsdk, NULL);
    PNError* serr = NULL;
    voxgig_value* items = batch_message_stream(se, "list", NULL, NULL, &serr);
    ...
    Entity* pe = thesmsworks_batch_message(plainsdk, NULL);
    PNError* perr = NULL;
    voxgig_value* pitems = batch_message_stream(pe, "list", NULL, NULL, &perr);

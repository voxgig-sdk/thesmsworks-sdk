...
int main(void) {
  ...
  // the materialised items — either way every item is yielded.
  {
    ...
    Entity* se = thesmsworks_batch(strsdk, NULL);
    PNError* serr = NULL;
    voxgig_value* items = batch_stream(se, "list", NULL, NULL, &serr);
    ...
    Entity* pe = thesmsworks_batch(plainsdk, NULL);
    PNError* perr = NULL;
    voxgig_value* pitems = batch_stream(pe, "list", NULL, NULL, &perr);

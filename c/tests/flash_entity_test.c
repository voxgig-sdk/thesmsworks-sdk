...
int main(void) {
  ...
  // the materialised items — either way every item is yielded.
  {
    ...
    Entity* se = thesmsworks_flash(strsdk, NULL);
    PNError* serr = NULL;
    voxgig_value* items = flash_stream(se, "list", NULL, NULL, &serr);
    ...
    Entity* pe = thesmsworks_flash(plainsdk, NULL);
    PNError* perr = NULL;
    voxgig_value* pitems = flash_stream(pe, "list", NULL, NULL, &perr);

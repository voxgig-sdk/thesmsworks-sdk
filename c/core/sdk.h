// Thesmsworks SDK — umbrella runtime header (template; Thesmsworks tokens
...
#ifndef THESMSWORKS_SDK_H
#define THESMSWORKS_SDK_H
...
typedef struct ThesmsworksSDK ThesmsworksSDK;
...
// ===========================================================================
// Error (mirrors core/error.rs ThesmsworksError)
// ===========================================================================

typedef struct PNError {
  char* sdk;   // "Thesmsworks"
...
// ===========================================================================
// Entity (vtable; mirrors core/types.rs Entity + ThesmsworksEntity)
// ===========================================================================
...
typedef struct EntityVT {
  ...
  // CRUD ops (ThesmsworksEntity). On error set *err and return NULL.
...
// ===========================================================================
// SDK client (mirrors Main.fragment ThesmsworksSDK) — generic fields.
// ===========================================================================

struct ThesmsworksSDK {
  char* mode;             // "live" | "test"
  voxgig_value* options;
  Utility* utility;
...
void sdk_features_push(ThesmsworksSDK* sdk, Feature* f);
void sdk_features_insert(ThesmsworksSDK* sdk, size_t i, Feature* f);
void sdk_features_replace(ThesmsworksSDK* sdk, size_t i, Feature* f);

voxgig_value* sdk_options_map(ThesmsworksSDK* sdk); // deep clone of options
Utility* sdk_get_utility(ThesmsworksSDK* sdk);      // utility_copy
Context* sdk_get_root_ctx(ThesmsworksSDK* sdk);

// Constructors / prepare / direct are in the generated client.c:
ThesmsworksSDK* thesmsworks_sdk_new(voxgig_value* options);
ThesmsworksSDK* test_sdk(voxgig_value* testopts, voxgig_value* sdkopts);
voxgig_value* sdk_prepare(ThesmsworksSDK* sdk, voxgig_value* fetchargs, PNError** err);
voxgig_value* sdk_direct(ThesmsworksSDK* sdk, voxgig_value* fetchargs, PNError** err);
voxgig_value* sdk_graphql(ThesmsworksSDK* sdk, const char* query,

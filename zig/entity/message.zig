...
pub const MessageEntity = struct {
    ...
    pub fn load(self: *MessageEntity, reqmatch: Value, ctrl: Value) OpResult {
    ...
    pub fn create(self: *MessageEntity, reqdata: Value, ctrl: Value) OpResult {
        const ctx = self.utility.make_context(CtxSpec{
            .opname = "create",
            .ctrl = ctrl,
            .mtch = self.mtch,
    ...
    pub fn remove(self: *MessageEntity, reqmatch: Value, ctrl: Value) OpResult {
        const ctx = self.utility.make_context(CtxSpec{
            .opname = "remove",
            .ctrl = ctrl,
            .mtch = self.mtch,

...
func registerSDKWords(r *eng.Registry, client *sdk.ThesmsworksSDK) {
...
func runOp(client *sdk.ThesmsworksSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
